...
function HomeContent() {
  ...
  return (
    <>
      ...
      <section id="page-tuition_aid-section" className="tuitiona-aid-section bg-bg100 flex items-end md:items-center relative overflow-hidden pt-5 sm:pt-10  md:pt-16 -mt-[2px] bgw" data-locomotive-section-id="page-tuition_aid" data-locomotive-section-type="tuition_aid" style={{
        paddingTop: "0px", gridrowgap: "7px"
      }}>
      ...
      <section id="page-tuition_aid-section" className="tuitiona-aid-section bg-bg100 flex items-end md:items-center relative overflow-hidden pt-5 sm:pt-10  -mt-[2px]" data-locomotive-section-id="page-tuition_aid" data-locomotive-section-type="tuition_aid" style={{ background: "none" }}>
        ...
        <div style={{ marginTop: "0px", display: "flex", background: "#ffffff" }} className="min-h-full h-full w-full mx-auto relative z-[4] flex  md:flex-row justify-end md:justify-between md:items-center" >
