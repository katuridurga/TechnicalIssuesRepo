...
const Testimonials = () => {
  ...
  const cardWidth = 350; // 330 + 20 margin
  ...
  const scrollToPage = (pageIndex) => {
    ...
    const scrollWidth = 330 * 3 + 20 * 2; // exact width of visible area
    container.scrollTo({
  ...
  // 🔥 Filter to only complete pages (groups of 3)
