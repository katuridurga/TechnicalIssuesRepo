...
import b21200 from "../assets/img/board_game-1200w.webp";
...
import b8400 from "../assets/img/awards/Nazara-400w.webp";
import b8600 from "../assets/img/awards/Nazara-600w.webp";
import b8696 from "../assets/img/awards/Nazara-696w.webp";
...
const slides = [
  ...
  {
    src: b2600,
    srcSet: `${b2400} 400w, ${b2600} 696w, ${b21200} 1200w`,
    sizes: "(max-width: 768px) 90vw, 696px",
  ...
  {
    src: b3693,
    srcSet: `${b3400} 400w, ${b3600} 600w, ${b3693} 693w, ${b31200} 1200w`,
    sizes: "(max-width: 768px) 90vw, 696px",
    alt: "Global Game Jam",
  ...
  {
    src: b8696,
    srcSet: `${b8400} 400w, ${b8600} 600w, ${b8696} 696w`,
    sizes: "(max-width: 768px) 90vw, 696px",
    alt: "Nazara",
    text: "Nazara",
  },
  ...
  { src: awardfoura, srcSet: `${awardfoura400} 400w, ${awardfoura700} 700w, ${awardfoura} 1200w`, sizes: "(max-width: 768px) 90vw, 696px", alt: "Backstage Pass College", text: "How Backstage Pass Gaming College Prepare Students to Join the Top Game and Technology Companies", href: "https://www.dnaindia.com/education/report-how-backstage-pass-gaming-college-prepare-students-to-join-the-top-game-and-technology-companies-2897946" },
  { src: awardfivea, srcSet: `${awardfivea400} 400w, ${awardfivea700} 700w, ${awardfivea} 1200w`, sizes: "(max-width: 768px) 90vw, 696px", alt: "Gaming Education India", text: "This gaming college in India is revolutionising gaming education", href: "https://www.forbesindia.com/article/brand-connect/this-gaming-college-in-india-is-revolutionising-gaming-education/60133/1" },
...
const EmblaCarousel = ({ options = {} }) => {
  ...
  const visibleSlides = useMemo(() => {
    return slides.filter(
      (_, index) => Math.abs(index - selectedIndex) <= 2
    );
  }, [selectedIndex]);
