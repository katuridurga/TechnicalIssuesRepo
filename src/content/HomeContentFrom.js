...
const [mainCategory, setMainCategory] = useState("");
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      setFormData({
        firstname: '', lastname: '', PhoneNumber: '', email: '', qualification: '', city: '', comments: '', url: window.location.href
      });
    } catch (error) {
            ...
            <div className="hidden md:block md:flex-1 self-start form-stcc">
              ...
              <form onSubmit={handleSubmit} className="formMain">
                <div className="formGrid" data-form-id="need-guidance" data-form="step1-container">
                  ...
                  <div className="">
                    <label className="" for="firstname">First Name <span style={{color:"red", marginLeft:"4px", marginTop:"2px"}}>*</span></label>
                  ...
                  <div className="">
                    <label className="" for="lastname">Last Name <span style={{color:"red", marginLeft:"4px", marginTop:"2px"}}>*</span></label>
                ...
                <div className="formGrid" data-form-id="need-guidance" data-form="step1-container">
                  <div className="">
                    <label className="" for="email">Email <span style={{color:"red", marginLeft:"4px", marginTop:"2px"}}>*</span></label>
                  ...
                  <div className="">
                    <label className="" for="qualification">Qualification <span style={{color:"red", marginLeft:"4px", marginTop:"2px"}}>*</span></label>
