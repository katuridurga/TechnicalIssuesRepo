...
<section id="page-tuition_aid-section" className="pd-m tuitiona-aid-section bg-bg100 flex items-end md:items-center relative overflow-hidden pt-5 sm:pt-10  md:pt-16 -mt-[2px]  bgw bgw12" data-locomotive-section-id="page-tuition_aid" data-locomotive-section-type="tuition_aid" style={{paddingTop: "20px", gridrowgap: "7px"
}}>
