...
import gadunit from "../../../assets/img/banners/Diploma-in-Game-Development-with-Unity.webp";
import gadunitm from "../../../assets/img/mobilebanner/Diploma_in_Game_Development_with_Unreal_mobile.webp"; 
...
function Courses(props) {
  ...
  <div className={isMobileState ? "MobileClassbsc" : "bcsgdd"}>
              {!isMobileState && (
                <img
                  src={gadunit}
                  alt="Learn Unity game engine – game development course in Hyderabad"
