  ...
  return (
    <>
          ...
          <div className=''>
            <ul>
              <li style={{ height: "auto" }}>
                ...
                <p style={{ color: "#000" }}>
                  Want to know more about the college, courses, fee structure or <b style={{ fontSize: "16px", color: '#ed1925' }}>
                  <a href="/admissions/admission-process/" style={{ fontSize: "16px", color: '#ed1925' }} target="_blank" rel="noopener noreferrer">admission process</a></b>? Call or write to us!</p>
      ...
      <section className="max-w-3xl mx-auto p-6 iconsv" style={{ background: "#fff", color: "#000" }}>
        ...
        <h2 className="mainHeadingTotal" style={{ color: "#ec1923" }}>Frequently Asked Questions</h2>
          ...
          {faqs.map((faq, index) => (
            <div
              ...
              >
                {/* Icon inside circle */}
                <span
                  className="btn-faq w-8 h-8 flex items-center justify-center border border-gray-400 rounded-full text-black"
                  style={{
                    background: "#fff",
                    color: "#000",
