    ...
    <>
      ...
      <div className={isMobileState ? "MobileClassbsc" : "bcsgdd"}>
        {!isMobileState && (
          <img
            src={arvrd}
            alt="AR VR course in India – augmented and virtual reality development training"
            className="bcsgdd"
          />
        )}
        {isMobileState && (
        ...
        <div className="et_pb_rowa" style={{ flexDirection: 'column' }}>
          <h1 className="title white-txt">Bachelor's in Augmented Reality
            <br />& Virtual Reality </h1>
