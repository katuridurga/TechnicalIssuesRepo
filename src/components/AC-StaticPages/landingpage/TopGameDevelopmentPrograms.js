...
import csgdc from "../../../assets/img/Courses/csgdc.webp"
...
function DiplomaAndAdvancedDiplomaCourses({ active, props }) {
  ...
  const [formData, setFormData] = useState({
    ...
    course_ttl: 6,// Initialize URL in state
  });
      ...
      <div className="row mb0">
        <div className="mainPanel1">
          ...
          <div style={{ width: isMobileState ? "100%" : "70%" }}>
            <div className={`et_pb_section bgimage et_pb_section_0 et_pb_with_background et_section_regular ${isMobileState ? 'MobileClassbsc12' : 'bsc22'}`} style={{ marginTop: isMobileState ? "40px" : "0px" }}>
            ...
            <div id="Career-Opportunitiesl" backgroundColor="brown" height="auto">
              ...
              <Box >
                ...
                >
                  <Tab style={{ color: "#fff", fontSize: isMobileState ? "12px" : "15px", fontFamily: "Montserrat, sans-serif", display: "flex", alignItems: "center", justifyContent: "center" }} label="Bachelor's Courses" />
                  <Tab style={{ color: "#fff", fontSize: isMobileState ? "12px" : "15px", fontFamily: "Montserrat, sans-serif", display: "flex", alignItems: "center", justifyContent: "center" }} label="Master's Courses" />
                  <Tab style={{ color: "#fff", fontSize: isMobileState ? "12px" : "15px", fontFamily: "Montserrat, sans-serif", display: "flex", alignItems: "center", justifyContent: "center" }} label="Diploma Courses" />
                ...
                <TabPanel value={value1} index={0} dir={theme.direction}>
                  ...
                  <Link className="CourseLink1" to={"/courses/bachelors-in-computer-science-and-game-development/"}>
                    <div className="mainCourse1">
                      <div className="mainCourseLeft1">
                        <img src={csgdc} alt="BACHELOR’S in Computer Science & Game Development" className="img-circle" />
                      </div>
                      <div className="mainCourseRight1">
                        ...
                        <p style={{ fontFamily: "'Montserrat', sans-serif" }}>Gain foundational knowledge in core Computer Science, software development, programming and game design with a focus on theoretical understanding and practical application.</p>
                  ...
                  <Link to={"/courses/bachelors-in-game-art-and-design/"}>
                    <div className="mainCourse1">
                      <div className="mainCourseLeft1">
                        <img src={GameArtDesign} alt="BACHELOR’S in Game Art & Design" className="img-circle" />
                      </div>
                      <div className="mainCourseRight1">
                        <h2 className="CourseHead1" style={{ fontFamily: "'Montserrat', sans-serif" }}>BACHELOR’S in Game Art & Design</h2>
                        <p style={{ fontFamily: "'Montserrat', sans-serif" }}>Want to combine your artistic talents with cutting-edge technology? Then this course is for you! Create visually stunning and immersive games by developing core skills in traditional and digital mediums.</p>
                  ...
                  <Link to={"/courses/bachelors-in-augmented-reality-and-virtual-reality/"}>
                    <div className="mainCourse1">
                      <div className="mainCourseLeft1">
                        <img src={AugmentedRealityandVirtualReality} alt="BACHELOR’S in Augmented Reality & Virtual Reality" className="img-circle" />
                      </div>
                      <div className="mainCourseRight1">
                ...
                <TabPanel value={value1} index={1} dir={theme.direction}>
                  <div className='courseUpdatesl'>
                    <ul>
                      ...
                      <li><img src={m2} alt="Eligibility icon"  />
                        <span>Eligibility : Graduation*</span></li>
            ...
            <div className="mainrec">
              <img src={infog} alt="infog" style={{ width: "100%" }} />
            </div>
