...
function DiplomaAndAdvancedDiplomaCourses({ active, props }) {
  ...
  return (
    <>
      <Helmet>
        <title>Game Development with Unreal | Backstage Pass
        </title>
        <meta  property="og:description" content="Game Development with Unreal" />
        ...
        <div className="mainPanel1">
          ...
          <div style={{ width: isMobileState ? "100%" : "100%", margin: isMobileState ? "50px auto" : "0px auto" }}>
            ...
            <a onClick={scrollToBottom}>
              <div className={`et_pb_section bgimage et_pb_section_0 et_pb_with_background et_section_regular ${isMobileState ? 'DGAMEDEVELOPMENTWITHUNITY3mc' : 'DGAMEDEVELOPMENTWITHUNITY3'}`}>

                <div className="et_pb_row et_pb_row_0">
                  <div className="et_pb_column et_pb_column_4_4 et_pb_column_0  et_pb_css_mix_blend_mode_passthrough et-last-child">
                    <div className="et_pb_module et_pb_text et_pb_text_0  et_pb_text_align_left et_pb_bg_layout_light">
                      <div className="et_pb_text_inner"><h1 className="title white-txt">Game Development with Unreal</h1></div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className='courseObj'>
              ...
              <ul>
                ...
                <li>Gameplay Essentials</li>
                <li>AI Development and Advanced Topics</li>
            ...
            <div className='courseObj'>
              <h2>Key Takeaways</h2>
              <ul>
                <li>Proficiency in C++ and Unreal Engine</li>
                <li>Multiplayer game development</li>
                <li>AI programming, game physics, animations</li>
                <li>Deployment across multiple platforms</li>
                <li>Comprehensive portfolio creation</li>
            ...
            <ul className="featuress3u">
              <li>
                <img src={ic9} alt="Unreal Developer" />
                <div className="featuresscon2">Unreal Developer</div>
              </li>

              <li>
                <img src={ic8} alt="Game/Gameplay Programmer" />
                <div className="featuresscon2">Game/Gameplay Programmer</div>
              </li>

              <li>
                <img src={ic7} alt="AI Programmer" />
                <div className="featuresscon2">AI Programmer</div>
              </li>

              <li>
                <img src={ic13} alt="Multiplayer Game Developer" />
                <div className="featuresscon2">Multiplayer Game Developer</div>
              </li>

              <li>
                <img src={ic9} alt="VR/AR Developer" />
                <div className="featuresscon2">VR/AR Developer</div>
              </li>

              <li>
                <img src={ic8} alt="Indie Game Developer" />
