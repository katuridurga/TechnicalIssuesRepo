        ...
        <div className="mainPanel1">
          ...
          <div style={{ width: isMobileState ? "100%" : "100%", margin: isMobileState ? "50px auto" : "0px auto" }}>
            ...
            <a onClick={scrollToBottom}>
              <div className={`et_pb_section bgimage et_pb_section_0 et_pb_with_background et_section_regular ${isMobileState ? 'DGAMEDEVELOPMENTWITHUNITYmc' : 'DGAMEDEVELOPMENTWITHUNITY'}`}>

                <div className="et_pb_row et_pb_row_0">
                  <div className="et_pb_column et_pb_column_4_4 et_pb_column_0  et_pb_css_mix_blend_mode_passthrough et-last-child">
                    <div className="et_pb_module et_pb_text et_pb_text_0  et_pb_text_align_left et_pb_bg_layout_light">
                      <div className="et_pb_text_inner"><h1 className="title white-txt">3D Hard Surface Modelling (Game Art)</h1></div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className='courseObj'>
              ...
              <ul>
                <li>Fundamentals of 3D Game Modeling</li>
                <li> Hard Surface Modeling Concepts</li>
                <li>UV Unwrapping and Optimization</li>
                <li> Texturing and Material Creation for Games</li>
                <li> Rendering, Game Engine Integration, and Portfolio Building</li>
              </ul>
            </div>
            ...
            <div className='courseObj'>
              <h2>Key Takeaways</h2>
              <ul>
                <li>Expertise in hard surface modeling for games</li>
                <li>Proficiency in UV unwrapping, PBR texturing</li>
                <li>Game engine asset integration</li>
                <li>Real-time rendering workflows</li>
            ...
            <ul className='featuress3u'>
              ...
              <li><img src={ic8} alt="ic1" />
                <div className='featuresscon2'>3D Environment/Prop/Vehicle Artist
                </div></li>
