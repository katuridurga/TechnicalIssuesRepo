        ...
        <div className="mainPanel1">
          ...
          <div style={{ width: isMobileState ? "100%" : "100%", margin: isMobileState ? "50px auto" : "0px auto" }}>
                ...
                <div className="et_pb_row et_pb_row_0">
                  <div className="et_pb_column et_pb_column_4_4 et_pb_column_0  et_pb_css_mix_blend_mode_passthrough et-last-child">
                    <div className="et_pb_module et_pb_text et_pb_text_0  et_pb_text_align_left et_pb_bg_layout_light">
                      <div className="et_pb_text_inner"><h1 className="title white-txt">AI-Powered Game Design and Level Building</h1></div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className='courseObj'>
              ...
              <ul>
                <li>Fundamentals of Game & Level Design</li>
                <li>World Building and AI-Driven Procedural Content</li>
                <li>AI in Game Design: Dynamic Interactions</li>
                <li>AI-Powered Level/Game Prototyping</li>
            ...
            <div className='courseObj'>
              <h2>Key Takeaways</h2>
              <ul>
                <li>Expertise in AI-driven game development</li>
            ...
            <ul className="featuress3u">
              ...
              <li>
                <img src={ic7} alt="AR/VR Level Designer" />
                <div className="featuresscon2">AR/VR Level Designer</div>
              </li>

              <li>
                <img src={ic13} alt="AI Game Content Designer" />
