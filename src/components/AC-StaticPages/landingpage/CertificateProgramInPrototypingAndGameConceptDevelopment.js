...
function DiplomaAndAdvancedDiplomaCourses({ active, props }) {
  ...
  return (
    <>
      <Helmet>
        <title> Certificate Program in Prototyping & Game Concept Development | Backstage Pass
        </title>
        <meta  property="og:description" content="Certificate Program in Prototyping & Game Concept Development" />
        ...
        <div className="mainPanel1">
          ...
          <div style={{ width: isMobileState ? "100%" : "100%", margin: isMobileState ? "50px auto" : "0px auto" }}>
            ...
            <a href ="" onClick={scrollToBottom}>
              <div className={`et_pb_section bgimage et_pb_section_0 et_pb_with_background et_section_regular ${isMobileState ? 'PROTOTYPINGGAMECONCEPTDEVELOPMENTmc' : 'PROTOTYPINGGAMECONCEPTDEVELOPMENT'}`}>

                <div className="et_pb_row et_pb_row_0">
                  <div className="et_pb_column et_pb_column_4_4 et_pb_column_0  et_pb_css_mix_blend_mode_passthrough et-last-child">
                    <div className="et_pb_module et_pb_text et_pb_text_0  et_pb_text_align_left et_pb_bg_layout_light">
                      <div className="et_pb_text_inner"><h1 className="title white-txt">Certificate Program in <br/>Prototyping & Game Concept Development</h1></div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className='Indtroduce'>
              <p> The Certificate Program in Prototyping & Game Concept Development is a course designed for aspiring game designers and developers. Covering paper prototyping, wireframing, and iterative design processes, this program equips participants with essential skills to transform ideas into playable concepts.</p>
              <p>Through structured exercises and industry-standard tools, learners will master the fundamentals of game prototyping, test game mechanics efficiently, and develop structured game concepts ready for development and pitching.</p>
            </div>
            ...
            <div className='courseObj'>
              ...
              <ul>
                <li>Understand the fundamentals of game prototyping and concept development.</li>
                <li> Develop paper prototypes to quickly test game mechanics and interactions.</li>
                <li> Learn wireframing techniques for structuring game interfaces and flows.</li>
                <li> Explore iterative design processes to refine game ideas efficiently.</li>
                <li> Learn industry best practices for presenting and pitching game concepts.</li>
              </ul>
            </div>
            ...
            <div className='courseObj'>
              <h2>Key Takeaways</h2>
              <ul>
                <li>Develop the ability to prototype game ideas quickly and efficiently.</li>
                <li>Gain expertise in paper prototyping and wireframing techniques.</li>
                <li>Learn iterative design processes to refine and improve game mechanics.</li>
                <li>Understand playtesting methods to evaluate game concepts effectively.</li>
                <li>Develop structured documentation and presentations for game pitches.</li>
              </ul>
            </div>
            ...
            <div className='courseObj1'>
              ...
              <ul>
                <li>Foundations of Game Prototyping</li>
                <li>Wireframing & Digital Prototyping</li>
                <li>Iterative Design & Playtesting </li>
                <li>Pitching & Presenting Game Concepts</li>
              </ul>
            </div>
            ...
            <ul className='featuress3u'>
              ...
              <li><img src={ic8} alt="ic1" />
                <div className='featuresscon2'>Game Prototype Developer
                </div></li>

              <li><img src={ic7} alt="ic1" />

                <div className='featuresscon2'>UX/UI Designer for Games


                </div></li>
              <li><img src={ic13} alt="ic1" />
                <div className='featuresscon2'>Game Concept Artist
              ...
              <li><img src={ic10} alt="ic1" />
                ...
                <div className='featuresscon2'>Interactive Experience Designer
