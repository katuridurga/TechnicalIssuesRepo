        ...
        <div className="mainPanel1">
          ...
          <div style={{ width: isMobileState ? "100%" : "100%", margin: isMobileState ? "50px auto" : "0px auto" }}>
            ...
            <a onClick={scrollToBottom}>
              <div className={`et_pb_section bgimage et_pb_section_0 et_pb_with_background et_section_regular ${isMobileState ? 'DGAMEDEVELOPMENTWITHUNITY5mc' : 'DGAMEDEVELOPMENTWITHUNITY5'}`}>

                <div className="et_pb_row et_pb_row_0">
                  <div className="et_pb_column et_pb_column_4_4 et_pb_column_0  et_pb_css_mix_blend_mode_passthrough et-last-child">
                    <div className="et_pb_module et_pb_text et_pb_text_0  et_pb_text_align_left et_pb_bg_layout_light">
                      <div className="et_pb_text_inner"><h1 className="title white-txt">Certificate Program in <br/>3D Game Development with Unity</h1></div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className='Indtroduce'>
              <p>The Certificate Program in 3D Game Development with Unity is a 20-hour live interactive course designed for beginners to learn the fundamentals of 3D game development using Unity.</p>
              <p>This program covers game mechanics, C# scripting, environment design, AI-driven interactions, and UI implementation, providing hands-on experience through 10 structured sessions.</p>
            </div>
            ...
            <div className='courseObj'>
              ...
              <ul>
                <li>Learn the fundamentals of 3D game development and Unity’s workflow.</li>
                <li> Understand C# scripting for gameplay mechanics, object interactions, and physics.</li>
                <li> Develop 3D environments with lighting, materials, and terrain generation.</li>
                <li> Implement AI-driven enemy behaviors and interactive NPCs.</li>
                <li> Create player controls, animations, and UI elements for an immersive experience.</li>
              </ul>
            </div>
            ...
            <div className='courseObj'>
              <h2>Key Takeaways</h2>
              <ul>
                <li>Understand Unity’s interface and core game development concepts.</li>
                <li>Gain proficiency in C# scripting for gameplay mechanics.</li>
                <li>Create interactive 3D environments with AI-driven elements.</li>
                <li>Implement player controls, animations, and NPC interactions.</li>
                <li>Learn optimization techniques for smoother gameplay performance.</li>
                <li>Understand game deployment for different platforms</li>
              </ul>
            </div>
            ...
            <div className='courseObj1'>
              ...
              <ul>
                <li>Introduction to Unity & Game Development</li>
<li>Level Design & Environment Creation</li>
<li>AI, Player Controls &Gameplay Mechanics</li>
<li>Game Optimization</li>
            ...
            <ul className='featuress3u' style={{backgroundColor:"#222"}}>
              <li><img src={ic9} alt="ic1" />
                ...
                <div className='featuresscon2'>Junior Unity Developer
              ...
              <li><img src={ic7} alt="ic1" />
                ...
                <div className='featuresscon2'>Technical Artist (Unity)
      ...
      {isButtonVisible && (
        ...
        </button>  <button className="dwnbtn three w-full sm:w-auto" style={{ width: "450px" }} onClick={handleClickss}>Pay Now          </button> </div>
      )}
