...
function DiplomaAndAdvancedDiplomaCourses({ active, props }) {
  ...
  const [formData, setFormData] = useState({
    ...
    course_ttl: 14,// Initialize URL in state
  ...
  return (
    <>
      <Helmet>
        <title> Short course on Certified Skill Diploma in Game Design with Unreal Blueprints
        ...
        <div className="mainPanel1">
          ...
          <div style={{ width: isMobileState ? "100%" : "100%", margin: isMobileState ? "50px auto" : "0px auto" }}>
            ...
            <div onClick={scrollToBottom}>
              <div className={`et_pb_section bgimage et_pb_section_0 et_pb_with_background et_section_regular ${isMobileState ? 'gamedesignbluepm' : 'gamedesignbluep'}`}>

                <div className="et_pb_row et_pb_row_0">
                  <div className="et_pb_column et_pb_column_4_4 et_pb_column_0  et_pb_css_mix_blend_mode_passthrough et-last-child">
                    <div className="et_pb_module et_pb_text et_pb_text_0  et_pb_text_align_left et_pb_bg_layout_light">
                      <div className="et_pb_text_inner"><h1 className="title white-txt">Certified Skill Diploma in Game Design with Unreal Blueprints
            ...
            <ul className='featuress2'>
              <li><img src={ic1} alt="ic1" />
                ...
                <div className='featuresscon2'>Game Design Principles


                </div></li>
              <li><img src={ic2} alt="ic1" />

                <div className='featuresscon2'>Level Design & World Building
              ...
              <li><img src={icg} alt="ic1" style={{ height: isMobileState ? "30px" : "50px", width: isMobileState ? "30px" : "50px" }} />
                ...
                <div className='featuresscon2'>Introduction to Unreal Blueprints


                </div></li>
              <li><img src={ic4} alt="ic1" />

                <div className='featuresscon2'>Game Prototype & Mechanics Development
              ...
              <li><img src={ic5} alt="ic1" />
                ...
                <div className='featuresscon2'>Game Production & Project Management
            ...
            <ul className='featuress3u'>
              ...
              <li><img src={ic9} alt="ic1" />
                ...
                <div className='featuresscon2'>Blueprint Scripter

                </div></li>
              <li><img src={ic8} alt="ic1" />
                <div className='featuresscon2'>Game Producer
              ...
              <li><img src={ic11} alt="ic1" />
                <div className='featuresscon2'>VR/AR Content Creator



                </div></li>
              <li><img src={ic13} alt="ic1" />
                <div className='featuresscon2'>Technical Game Designer
                </div></li>
              <li><img src={ic9} alt="ic1" />
              ...
              <li><img src={ic8} alt="ic1" />
                <div className='featuresscon2'>Gameplay Scripter
              ...
              <div>
                ...
                <ul className='featuress3'>
                  ...
                  <li><img src={ic7} alt="ic1" />
                    ...
                    <div className='featuresscon2'>Expertise in game design and player engagement
                  ...
                  <li><img src={ic13} alt="ic1" />
                    <div className='featuresscon2'>Experience in Unreal Engine level design

                    </div></li>
                  <li><img src={ic9} alt="ic1" />

                    <div className='featuresscon2'>Proficient in Blueprint scripting


                    </div></li>
                  <li><img src={ic8} alt="ic1" />
                    <div className='featuresscon2'>Ability to create prototypes without coding
                  ...
                  <li><img src={ic10} alt="ic1" />
                    ...
                    <div className='featuresscon2'>Skilled in UI/UX, AI, and balancing
                  ...
                  <li><img src={ic9} alt="ic1" />
                    ...
                    <div className='featuresscon2'>Knowledge of game production workflows
                  ...
                  <li><img src={ic10} alt="ic1" />
                    ...
                    <div className='featuresscon2'>Strong Unreal Engine portfolio
