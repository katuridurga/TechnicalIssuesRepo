...
import bscgadm from "../../../assets/img/mobilebanner/BachelorsGameArtDesign.webp";
import bscgadd from "../../../assets/img/banners/Bachelors-in-Game-Art-Design.webp";
    ...
    <>
        ...
        <div className={isMobileState ? "MobileClassbsc" : "bcsgdd"}>
                                {!isMobileState && (
                                  <img
                                    src={bscgadd}
                                    alt="Bachelor’s in Game art and design course in Hyderabad"
                                    className="bcsgdd"
                                  />
                                )}
                              {isMobileState && (
                                ...
                                <div className="et_pb_rowa" style={{flexDirection:'column'}}>
                                  <h1 className="title white-txt">Bachelor's in Game Art & Design</h1>
